...
print(f'{user_name} from {user_city} has {years_experience:5.1f} years of experience and completed {project_count} projects.')

years_experience = 5 # updates value of the variable
